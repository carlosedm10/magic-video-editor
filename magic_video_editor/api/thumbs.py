...
its grid metadata, and the audio-peaks JSON that magic_video_editor/pipeline/thumbs.py
generates into <project>/thumbs/.

Mounted in server.py. Also imports magic_video_editor.pipeline.thumbs (for its side
